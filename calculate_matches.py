# Program calculates the percentage of dialogue lines which have gotten a timestamp,
# these are the dialogue lines which are exactly the same in both the script as the .srt file
...
def calculate_matches(infile):
	...
	# For every 'timestamp' increase matches by 1 (only matches get a timestamp)
